<h2>271. Encode and Decode Strings</a></h2><h3><a href='https://leetcode.com/problems/encode-and-decode-strings' target="_blank"><img alt='leetcode' src='https://img.shields.io/badge/Medium-100000?style=flat&logo=leetcode'/></a></h3><hr><p>Design an algorithm to encode <b>a list of strings</b> to <b>a string</b>. The encoded string is then sent over the network and is decoded back to the original list of strings.</p>
...
<pre>
let encoded_string = encode(strs);
</pre>

<p>and Machine 2 does:</p>

<pre>
let strs2 = decode(encoded_string);
</pre>
...
Machine 1:
let codec = Codec::new();
let msg = codec.encode(strs);
Machine 1 ---msg---&gt; Machine 2

Machine 2:
let codec = Codec::new();
let strs = codec.decode(msg);
</pre>
